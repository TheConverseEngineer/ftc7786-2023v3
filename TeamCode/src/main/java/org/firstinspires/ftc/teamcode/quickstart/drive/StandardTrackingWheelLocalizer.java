...
import org.firstinspires.ftc.teamcode.quickstart.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.202620937011726; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -3.89; // in; offset of the lateral wheel
